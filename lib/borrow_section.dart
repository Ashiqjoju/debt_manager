...
class _TabTwoContentState extends State<TabTwoContent> {
  List<Map<String, dynamic>> entries3 = [];
  ...
  void _loadEntries() async {
    ...
    List<String> entriesJson1 = prefs.getStringList('entries3') ?? [];
    List<String> entriesJson2 = prefs.getStringList('entries4') ?? [];

    setState(() {
      entries3 = entriesJson1.map((entryJson) {
  ...
  void _saveEntries() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    List<String> entriesJson1 = entries3.map((entry) {
    ...
    prefs.setStringList('entries3', entriesJson1);
  ...
  Widget build(BuildContext context) {
    double grandTotal = getTotalSum(entries3) ;
            ...
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final entry = entries3[entries3.length - index - 1];
                  return CupertinoButton(
                    padding: EdgeInsets.zero,
                    onPressed: () => _showDetailsDialog(entry, entries3.length - index - 1, entries3),
                    child: Container(
